...
juce::File const SPLASH_SCREEN_FILE{ RESOURCES_DIR.getChildFile("splash_screen_v4.png") };
...
juce::File const DEFAULT_CUBE_PROJECT{ RESOURCES_DIR.getChildFile(
...
juce::File const MANUAL_FILE_EN{ RESOURCES_DIR.getChildFile("SpatGRIS_4.1.5_Manual_EN.pdf") };
juce::File const MANUAL_FILE_FR{ RESOURCES_DIR.getChildFile("SpatGRIS_4.1.5_Manuel_FR.pdf") };
