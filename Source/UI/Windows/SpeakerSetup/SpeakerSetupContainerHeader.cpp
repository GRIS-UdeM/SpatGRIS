...
SpeakerSetupContainerHeader::SpeakerSetupContainerHeader(GrisLookAndFeel & glaf) : grisLookAndFeel(glaf)
{
    ...
    constexpr std::array<SpeakerColumnHeader::ColumnID, 8> headerKeys = {
        ...
        SpeakerColumnHeader::ColumnID::Z,         SpeakerColumnHeader::ColumnID::Azimuth,
        SpeakerColumnHeader::ColumnID::Elevation, SpeakerColumnHeader::ColumnID::Distance,
        SpeakerColumnHeader::ColumnID::Gain,      SpeakerColumnHeader::ColumnID::Highpass,
    };
...
void SpeakerSetupContainerHeader::setSortFunc(
    std::function<void(SpeakerColumnHeader::ColumnID, int sortDirection)> sort)
{
    sortFunc = sort;
}
} // namespace gris
