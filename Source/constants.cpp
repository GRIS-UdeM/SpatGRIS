...
{
juce::String const DEVICE_TYPE = "audioDeviceType";
juce::String const INPUT_DEVICE = "inputDevice";
juce::String const OUTPUT_DEVICE = "outputDevice";
juce::String const BUFFER_SIZE = "BufferValue";
juce::String const SAMPLE_RATE = "RateValue";
juce::String const OSC_INPUT_PORT = "OscInputPort";
juce::String const FILE_FORMAT = "FileFormat";
juce::String const FILE_CONFIG = "FileConfig";
juce::String const ATTENUATION_DB = "AttenuationDB";
juce::String const ATTENUATION_HZ = "AttenuationHz";

juce::String const LAST_VBAP_SPEAKER_SETUP = "lastVbapSpeakerSetup";
juce::String const LAST_OPEN_PRESET = "lastOpenPreset";
juce::String const LAST_OPEN_SPEAKER_SETUP = "lastOpenSpeakerSetup";
juce::String const LAST_RECORDING_DIRECTORY = "lastRecordingDirectory";
juce::String const SASH_POSITION = "sashPosition";
} // namespace user_properties_tags
...
//==============================================================================
juce::String recordingConfigToString(RecordingConfig const config)
{
    switch (config) {
    case RecordingConfig::interleaved:
        return "Single Interleaved";
    case RecordingConfig::mono:
        return "Multiple Mono Files";
    }
    jassertfalse;
    return "";
}
...
{
    if (string == "Single Interleaved") {
        return RecordingConfig::interleaved;
    }
    if (string == "Multiple Mono Files") {
        return RecordingConfig::mono;
    }
    return std::nullopt;
}
