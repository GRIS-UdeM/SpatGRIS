...
{
//==============================================================================
void SpeakerHighpassConfig::process(float * data, int const numSamples, ColdSpeakerHighpass & state, const double whiteNoise) const
{
    for (int sampleIndex{}; sampleIndex < numSamples; ++sampleIndex) {
        auto const sample{ static_cast<double>(data[sampleIndex]) + whiteNoise * DENORM_GAIN };
