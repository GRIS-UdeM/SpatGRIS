...
const juce::String DefaultSpeakerSetupFilePath = CURRENT_WORKING_DIR + RESOURCES_DIR + "default_preset/default_speaker_setup.xml";
const juce::String BinauralSpeakerSetupFilePath = CURRENT_WORKING_DIR + RESOURCES_DIR + "default_preset/BINAURAL_SPEAKER_SETUP.xml";
const juce::String StereoSpeakerSetupFilePath = CURRENT_WORKING_DIR + RESOURCES_DIR + "default_preset/STEREO_SPEAKER_SETUP.xml";
...
const juce::String HRTFFolder40Path = CURRENT_WORKING_DIR + RESOURCES_DIR + "hrtf_compact/elev" + juce::String(40) + "/";
const juce::String HRTFFolder80Path = CURRENT_WORKING_DIR + RESOURCES_DIR + "hrtf_compact/elev" + juce::String(80) + "/";
